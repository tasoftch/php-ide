...
//  Skyline Editor X
//
//  Created by Thomas Abplanalp on 28.03.17.
...
char* fd_read_line_delim(int socket, fd_buf *context, int type, unsigned char delim, long *length)
{
	int size = 0;
	long newl = 0, nbufsize = 0;
	char *tmp;
	char *tmp_buf = NULL;
	char *ptr;
